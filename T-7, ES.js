...
const questions = [
  {
    numb: 1,
    question: "A Fahrenheit thermometer indicates a temperature of ‘ 14°F. its corresponding reading on the Celsius scale will be _________?",
    answer: "– 10°C",
    options: [
      "+ 10°C",
      "+ 20°C",
  ...
  {
    numb: 2,
    question: "A satellite moving round the earth with a uniform speed has____________?",
  ...
  {
    numb: 3,
    question: "The biggest planet in our solar system is___________?",
    answer: "Jupiter",
    options: [
      "Venus",
      "Pluto",
  ...
  },
  {
    ...
    answer: "A pair of forces acting along the same line and in opposite direction",
    options: [
      "A single force",
  ...
  {
    numb: 9,
    question: "The soul of chemistry is dealing with___________?",
    answer: "Composition and properties of matter",
    options: [
  ...
  {
    numb: 10,
    question: "Moon light reaches to earth in___________seconds?",
    answer: "1.3 seconds",
    options: [
      "0.3 seconds",
      "1.3 seconds",
  ...
  {
    numb: 12,
    question: "Sodium carbonate is produced by____________?",
    answer: "Amonia solvay process",
    options: [
  ...
  {
    numb: 14,
    question: "In the manufacture of banaspati ghee the gas used is __________?",
    answer: "Hydrogen",
    options: [
      "Helium",
      "Hydrogen",
  ...
  },
  {
    ...
    answer: "Radio waves detectable from Earth",
    options: [
  ...
  },
  {
    ...
    answer: "The distance covered during the time interval divided by the time interval",
    options: [
  ...
  },
  {
    ...
    answer: "Depends on the gas used in the discharge tube",
    options: [
  ...
  {
    numb: 19,
    question: "The amount of energy required by the children of age between one to three years is___________?",
    answer: "1200 k Calories ",
    options: [
      "300 k Calories",
      "600 k Calories",
      "900 k Calories",
  ...
  {
    numb: 20,
    question: "The season changes because of the ____________?",
    answer: "Earth is revolving round the sun",
    options: [
